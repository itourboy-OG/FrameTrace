...
$publishDirectory = Join-Path $projectRoot 'artifacts/app-0.7.13'
...
Copy-Item -LiteralPath (Join-Path $projectRoot '../FrameTrace-0.7.13-Setup.exe') -Destination $desktopReleases
