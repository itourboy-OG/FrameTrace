...
$publishDirectory = Join-Path $projectRoot 'artifacts/app-0.7.10'
...
Copy-Item -LiteralPath (Join-Path $projectRoot '../FrameTrace-0.7.10-Setup.exe') -Destination $desktopReleases
